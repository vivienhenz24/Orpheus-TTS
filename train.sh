...
_DEFAULT_DATASET_DIR="$ROOT_DIR/artifacts/datasets/orpheus_tr_$([[ "${PHONEMIZE:-1}" == "1" ]] && echo "phoneme" || echo "processed")"
PROCESSED_DIR="${PROCESSED_DIR:-$_DEFAULT_DATASET_DIR}"
